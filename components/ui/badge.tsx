...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-0.5 text-xs font-semibold transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        romantic: "border-primary/20 bg-pink-50/50 text-primary hover:bg-pink-50/80 hover:shadow-md backdrop-blur-sm",
      },
    },
    defaultVariants: {
      variant: "default",
