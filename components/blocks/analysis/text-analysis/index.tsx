                ...
                <div className="flex-shrink-0 flex items-center justify-center w-full md:w-40">
                  <div className="w-32 h-32">
                    <CircularProgressbar
                      ...
                      styles={buildStyles({
                        textSize: '1.5rem',
                        pathColor: textAnalysis.sentimentScore >= 0.7 ? 'hsl(var(--chart-1))' :
                                  textAnalysis.sentimentScore >= 0.5 ? 'hsl(var(--chart-2))' :
                                  textAnalysis.sentimentScore >= 0.3 ? 'hsl(var(--chart-3))' :
                                  textAnalysis.sentimentScore >= 0.1 ? 'hsl(var(--chart-4))' : 'hsl(var(--chart-5))',
