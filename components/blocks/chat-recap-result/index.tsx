    ...
    <div className={`w-full py-6 ${className}`}>
      <div className="container max-w-5xl mx-auto px-0">
        ...
        <div className="space-y-6">
          ...
          {/* Overview Block */}
          <div>
            <h2 className="text-2xl font-bold mb-1">{t("overview_title")}</h2>
          ...
          {/* Time Analysis Block */}
          <div>
            <h2 className="text-2xl font-bold mb-1">{t("time_analysis_title")}</h2>
            <div className="[&_h2]:hidden">
              <TimeAnalysisBlock
                timeAnalysis={analysisData.timeAnalysis}
              />
          ...
          {/* Text Analysis Block */}
          <div>
            <h2 className="text-2xl font-bold mb-1">{t("text_analysis_title")}</h2>
            <div className="[&_h2]:hidden">
              <TextAnalysisBlock
