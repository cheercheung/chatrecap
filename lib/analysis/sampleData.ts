  ...
  return {
    ...
    timeAnalysis: {
      ...
      dailyActivity: [
        ...
        {date: "Jan 8", count: 19},
        {date: "Jan 9", count: 22},
        {date: "Jan 10", count: 18},
        {date: "Jan 11", count: 50},
        {date: "Jan 12", count: 23},
        {date: "Jan 13", count: 19},
        {date: "Jan 14", count: 22},
        {date: "Jan 15", count: 24},
        {date: "Jan 16", count: 18},
        {date: "Jan 17", count: 19},
        {date: "Jan 18", count: 22},
        {date: "Jan 19", count: 19},
        {date: "Jan 20", count: 22},
        {date: "Jan 21", count: 80},
        {date: "Jan 22", count: 30},
        {date: "Jan 23", count: 22},
        {date: "Jan 24", count: 18},
        {date: "Jan 25", count: 15},
        {date: "Jan 26", count: 13},
        {date: "Jan 27", count: 14},
